...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // تعديل دالة changeImage
    const originalChangeImage = lightbox.changeImage;

    lightbox.changeImage = function (index) {

        originalChangeImage.call(this, index);

        // بعد تحميل الصورة — إجبار المقاسات      
        const img = this.$image;
        const box = this.$outerContainer;

        const size = window.innerHeight * 0.95;
        ...
        // الصورة auto width/height ومتمركزة
        img.css({
            maxWidth: "100%",
            maxHeight: "100%",
            width: "auto",
